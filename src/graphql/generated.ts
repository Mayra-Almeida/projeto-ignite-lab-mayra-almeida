...
export type GetLessonsBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, description?: string | null, videoId: string, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };
